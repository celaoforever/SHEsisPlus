...
void Haplotype::getBiallelicCoding(int ploidy,int which_genotype, int which_index, int which_allele){
...
void Haplotype::getGeneralCoding(int ploidy, int which_genotype, int which_index){
	std::stringstream tmpss;
...
void Haplotype::getGeneralCodingMissing(int ploidy, int which_genotype, int which_index ){
	std::stringstream tmpss;
	int number_of_different_alleles=this->occurence[which_genotype][which_index].size();
	int width=CEIL(log2(this->occurence[which_genotype][which_index].size()));
	std::vector< boost::shared_ptr< int[]> > mbool(number_of_different_alleles);
...
void Haplotype::getGeneralCodingTotalyMissing(int ploidy, int which_genotype, int which_index){
	std::stringstream tmpss;
	int number_of_different_alleles=this->occurence[which_genotype][which_index].size();
	int width=CEIL(log2(this->occurence[which_genotype][which_index].size()));
	std::vector< boost::shared_ptr< int[]> > mbool(number_of_different_alleles);
