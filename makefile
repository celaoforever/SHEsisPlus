...
SHEsis:	 main.o  SHEsisData.o fisher.o utility.o AssociationTest.o HWETest.o LDTest.o Haplotype.o HaplotypeDiploid.o IndexingVariables.o ArrayStorage.o System.o Solver.o Options.o  BMP.o font.o minifont.o 
...
LDTest_test: SHEsisData.o LDTest_test.o LDTest.o BMP.o font.o minifont.o Haplotype.o HaplotypeDiploid.o IndexingVariables.o ArrayStorage.o System.o Solver.o Options.o  fisher.o utility.o 
	$(CXX) -o LDTest_test SHEsisData.o LDTest_test.o LDTest.o BMP.o font.o minifont.o Haplotype.o HaplotypeDiploid.o IndexingVariables.o ArrayStorage.o System.o Solver.o Options.o   fisher.o utility.o 
