CXXFLAGS =	 -O0  -g -Wall -std=c++11 -fmessage-length=0  -L/home/ada/git/SHEsis/boost/boost_1_55_0/stage/lib -I/home/ada/git/SHEsis/boost/boost_1_55_0 -D __STDC_LIMIT_MACROS -D __STDC_FORMAT_MACROS  -Wno-parentheses
...
HaplotypeDiploid_test: SHEsisData.o HaplotypeDiploid_test.o fisher.o utility.o HaplotypeDiploid.o 
	$(CXX) -o HaplotypeDiploid_test SHEsisData.o HaplotypeDiploid_test.o fisher.o utility.o HaplotypeDiploid.o 
